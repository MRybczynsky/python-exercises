'''Pracujesz w Urzędzie Stanu Cywilnego i ... korzystasz z Pythona.
Dziewczyna o imieniu Kasia i nazwisku Sowa wychodzi za mąż za chłopaka
o nazwisku Mrugała.
Pani Kasia chce zachować oba nazwiska.'''


'''Zdefiniuj zmienne firstName, famillyName i lastName i przypisz do nich napisy
odpowiadające imieniu, nazwisku panieńskim i nowym nazwisku.
...
'''Zdefiniuj zmienną music o następującej zawartości (są to tytuły i autorzy
piosenek z filmu Minionki):
...
były umieszczone w nowej linii (znowu musisz w tekście dodać pewne znaki specjalne prezentowane na lekcji).'''
